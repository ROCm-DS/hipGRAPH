...
def spectral_modularity_maximization(ResourceHandle resource_handle,
    ...
    error_code = hipgraph_spectral_modularity_maximization(c_resource_handle_ptr,
                                                 c_graph_ptr,
                                                 num_clusters,
                                                 num_eigen_vects,
                                                 evs_tolerance,
                                                 ...
                                                 &result_ptr,
                                                 &error_ptr)
    assert_success(error_code, error_ptr, "hipgraph_spectral_modularity_maximization")
