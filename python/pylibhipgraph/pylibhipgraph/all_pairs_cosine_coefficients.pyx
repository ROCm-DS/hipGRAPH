...
def all_pairs_cosine_coefficients(ResourceHandle resource_handle,
    ...
    error_code = hipgraph_all_pairs_cosine_similarity_coefficients(c_resource_handle_ptr,
                                              c_graph_ptr,
                                              vertices_view_ptr,
                                              use_weight,
                                              topk,
                                              ...
                                              &result_ptr,
                                              &error_ptr)
    assert_success(error_code, error_ptr, "hipgraph_all_pairs_cosine_similarity_coefficients")
