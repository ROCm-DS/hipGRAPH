...
from pylibhipgraph._hipgraph_c.graph cimport (
    hipgraph_sg_graph_create_from_csr,  # FIXME: Remove this once
)
from pylibhipgraph._hipgraph_c.graph cimport (
    hipgraph_sg_graph_free,  # FIXME: Remove this
)
from pylibhipgraph._hipgraph_c.graph cimport (  # hipgraph_graph_create_mg,; 'hipgraph_graph_create_sg_from_csr' is exposed; hipgraph_mg_graph_free, #FIXME: Remove this
    hipgraph_graph_create_sg,
    hipgraph_graph_create_sg_from_csr,
    hipgraph_graph_free,
)
from pylibhipgraph.graph_properties cimport GraphProperties
...
cdef class SGGraph(_GPUGraph):
    ...
    def __cinit__(self,
        ...
        cdef hipgraph_type_erased_device_array_view_t* srcs_or_offsets_view_ptr = \
            create_hipgraph_type_erased_device_array_view_from_py_obj(
                src_or_offset_array
            )
        cdef hipgraph_type_erased_device_array_view_t* dsts_or_indices_view_ptr = \
            create_hipgraph_type_erased_device_array_view_from_py_obj(
                dst_or_index_array
            )
        cdef hipgraph_type_erased_device_array_view_t* vertices_view_ptr = \
            create_hipgraph_type_erased_device_array_view_from_py_obj(
                vertices_array
            )
        self.weights_view_ptr = create_hipgraph_type_erased_device_array_view_from_py_obj(
                weight_array
            )
        self.edge_id_view_ptr = create_hipgraph_type_erased_device_array_view_from_py_obj(
                edge_id_array
            )
        cdef hipgraph_type_erased_device_array_view_t* edge_type_view_ptr = \
            create_hipgraph_type_erased_device_array_view_from_py_obj(
                edge_type_array
            )

        if input_array_format == "COO":
            error_code = hipgraph_graph_create_sg(
            ...
            error_code = hipgraph_sg_graph_create_from_csr(
                resource_handle.c_resource_handle_ptr,
                &(graph_properties.c_graph_properties),
                srcs_or_offsets_view_ptr,
                dsts_or_indices_view_ptr,
        ...
        hipgraph_type_erased_device_array_view_free(srcs_or_offsets_view_ptr)
        hipgraph_type_erased_device_array_view_free(dsts_or_indices_view_ptr)
        if self.weights_view_ptr is not NULL:
            hipgraph_type_erased_device_array_view_free(self.weights_view_ptr)
        if self.edge_id_view_ptr is not NULL:
            hipgraph_type_erased_device_array_view_free(self.edge_id_view_ptr)
        if edge_type_view_ptr is not NULL:
            hipgraph_type_erased_device_array_view_free(edge_type_view_ptr)

    def __dealloc__(self):
        if self.c_graph_ptr is not NULL:
            hipgraph_sg_graph_free(self.c_graph_ptr)
...
#
#         cdef hipgraph_type_erased_device_array_view_t** srcs_view_ptr_ptr  = NULL
#         cdef hipgraph_type_erased_device_array_view_t** dsts_view_ptr_ptr  = NULL
#         cdef hipgraph_type_erased_device_array_view_t** vertices_view_ptr_ptr = NULL
#         cdef hipgraph_type_erased_device_array_view_t** edge_type_view_ptr_ptr = NULL
#
...
#                 if i == 0:
#                     srcs_view_ptr_ptr = \
#                         <hipgraph_type_erased_device_array_view_t **>malloc(
#                             num_arrays * sizeof(hipgraph_type_erased_device_array_view_t*))
#                 srcs_view_ptr_ptr[i] = \
#                     create_hipgraph_type_erased_device_array_view_from_py_obj(src_array[i])
#
...
#                             num_arrays * sizeof(hipgraph_type_erased_device_array_view_t*))
#                 dsts_view_ptr_ptr[i] = \
#                     create_hipgraph_type_erased_device_array_view_from_py_obj(dst_array[i])
#
...
#                     create_hipgraph_type_erased_device_array_view_from_py_obj(vertices_array[i])
#
...
#                     create_hipgraph_type_erased_device_array_view_from_py_obj(weight_array[i])
#
...
#                     create_hipgraph_type_erased_device_array_view_from_py_obj(edge_id_array[i])
#
...
#                     create_hipgraph_type_erased_device_array_view_from_py_obj(edge_type_array[i])
#
#         error_code = hipgraph_graph_create_mg(
#             resource_handle.c_resource_handle_ptr,
#             &(graph_properties.c_graph_properties),
#             vertices_view_ptr_ptr,
#             srcs_view_ptr_ptr,
...
#
#         for i in range(num_arrays):
#             hipgraph_type_erased_device_array_view_free(srcs_view_ptr_ptr[i])
#             hipgraph_type_erased_device_array_view_free(dsts_view_ptr_ptr[i])
#             if vertices_view_ptr_ptr is not NULL:
#                 hipgraph_type_erased_device_array_view_free(vertices_view_ptr_ptr[i])
#             if self.weights_view_ptr_ptr is not NULL:
#                 hipgraph_type_erased_device_array_view_free(self.weights_view_ptr_ptr[i])
#             if self.edge_id_view_ptr_ptr is not NULL:
#                 hipgraph_type_erased_device_array_view_free(self.edge_id_view_ptr_ptr[i])
#             if edge_type_view_ptr_ptr is not NULL:
#                 hipgraph_type_erased_device_array_view_free(edge_type_view_ptr_ptr[i])
#
#     def __dealloc__(self):
#         if self.c_graph_ptr is not NULL:
#             hipgraph_mg_graph_free(self.c_graph_ptr)
