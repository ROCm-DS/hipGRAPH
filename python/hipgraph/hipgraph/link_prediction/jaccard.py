...
from pylibhipgraph import (
    all_pairs_jaccard_coefficients as pylibhipgraph_all_pairs_jaccard_coefficients,
)
from pylibhipgraph import jaccard_coefficients as pylibhipgraph_jaccard_coefficients
...
def jaccard(
    ...
    hipgraph.jaccard, in the absence of a specified vertex pair list, will
    ...
    first, second, jaccard_coeff = pylibhipgraph_jaccard_coefficients(
...
def jaccard_coefficient(
    ...
    --------
    >>> from hipgraph.datasets import karate
    >>> from hipgraph import jaccard_coefficient
...
def all_pairs_jaccard(
    ...
    hipgraph.all_pairs_jaccard, in the absence of specified vertices, will
    compute the two_hop_neighbors of the entire graph to construct a vertex pair
    ...
    --------
    >>> from hipgraph.datasets import karate
    >>> from hipgraph import all_pairs_jaccard
    >>> input_graph = karate.get_graph(download=True, ignore_weights=True)
    ...
    first, second, jaccard_coeff = pylibhipgraph_all_pairs_jaccard_coefficients(
        resource_handle=ResourceHandle(),
        graph=input_graph._plc_graph,
        vertices=vertices,
        use_weight=use_weight,
