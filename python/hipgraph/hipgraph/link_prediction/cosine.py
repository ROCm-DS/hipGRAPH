...
from pylibhipgraph import (
    all_pairs_cosine_coefficients as pylibhipgraph_all_pairs_cosine_coefficients,
)
from pylibhipgraph import cosine_coefficients as pylibhipgraph_cosine_coefficients
...
def cosine(
    ...
    hipgraph.cosine, in the absence of a specified vertex pair list, will
    ...
    first, second, cosine_coeff = pylibhipgraph_cosine_coefficients(
...
def cosine_coefficient(
    ...
    --------
    >>> from hipgraph.datasets import karate
    >>> from hipgraph import cosine_coefficient
...
def all_pairs_cosine(
    ...
    hipgraph.all_pairs_cosine, in the absence of specified vertices, will
    compute the two_hop_neighbors of the entire graph to construct a vertex pair
    ...
    --------
    >>> from hipgraph.datasets import karate
    >>> from hipgraph import all_pairs_cosine
    >>> input_graph = karate.get_graph(download=True, ignore_weights=True)
    ...
    first, second, cosine_coeff = pylibhipgraph_all_pairs_cosine_coefficients(
        resource_handle=ResourceHandle(),
        graph=input_graph._plc_graph,
        vertices=vertices,
        use_weight=use_weight,
