...
def overlap_coefficient(
    ...
    >>> from hipgraph import overlap_coefficient
...
def overlap(
    ...
    first, second, overlap_coeff = pylibhipgraph_overlap_coefficients(
...
def all_pairs_overlap(
    ...
    --------
    >>> from hipgraph.datasets import karate
    >>> from hipgraph import all_pairs_overlap
    >>> input_graph = karate.get_graph(download=True, ignore_weights=True)
    ...
    first, second, overlap_coeff = pylibhipgraph_all_pairs_overlap_coefficients(
        resource_handle=ResourceHandle(),
        graph=input_graph._plc_graph,
        vertices=vertices,
        use_weight=use_weight,
