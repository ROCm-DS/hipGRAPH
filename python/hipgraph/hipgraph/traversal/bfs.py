...
def bfs(
    ...
    directed : bool, optional (default=None)
        ...
        If True, then convert the input matrix to a directed hipgraph.Graph,
        otherwise an undirected hipgraph.Graph object will be used.
    ...
    distances, predecessors, vertices = pylibhipgraph_bfs(
