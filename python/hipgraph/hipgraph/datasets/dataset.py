...
class DefaultDownloadDir:
    ...
    _default_base_dir = Path.home() / ".hipgraph/datasets"
...
class Dataset:
    """
    A Dataset Object, used to easily import edgelist data and hipGRAPH.Graph
    instances.
    ...
    def get_graph(
        ...
        create_using: hipgraph.Graph (instance or class), optional
        (default=Graph)
