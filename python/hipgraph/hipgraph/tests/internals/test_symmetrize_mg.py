...
def test_mg_symmetrize(dask_client, read_datasets):
    ...
    if val_col_name is not None:
        sym_src, sym_dst, sym_val = hipgraph.symmetrize(
        ...
        sym_src, sym_dst = hipgraph.symmetrize(ddf, src_col_name, dst_col_name)
...
def test_mg_symmetrize_df(dask_client, read_datasets):
    ...
    sym_ddf = hipgraph.symmetrize_ddf(ddf, src_col_name, dst_col_name, val_col_name)
