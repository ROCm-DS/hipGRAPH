...
import hipgraph
import pytest
from hipgraph import uniform_neighbor_sample
...
def test_uniform_neighbor_sample_simple(input_combo):
    ...
    #    1) Pylibhipgraph already does renumbering
...
def test_uniform_neighbor_sample_edge_properties_self_loops():
    ...
    sampling_results = hipgraph.uniform_neighbor_sample(
        G,
...
def test_uniform_neighbor_sample_renumber(hops):
    ...
    sampling_results_unrenumbered = hipgraph.uniform_neighbor_sample(
        G,
        seeds,
        hops,
        with_replacement=False,
    ...
    sampling_results_renumbered, renumber_map = hipgraph.uniform_neighbor_sample(
        G,
        seeds,
        hops,
        with_replacement=False,
...
def test_uniform_neighbor_sample_offset_renumber(hops):
    ...
    ) = hipgraph.uniform_neighbor_sample(
        G,
        seeds,
        hops,
        with_replacement=False,
...
def test_uniform_neighbor_sample_csr_csc_global(hops, seed):
    ...
    sampling_results, offsets, renumber_map = hipgraph.uniform_neighbor_sample(
        G,
        seeds,
        hops,
        with_replacement=False,
...
def test_uniform_neighbor_sample_retain_seeds():
    ...
    results, offsets, renumber_map = hipgraph.uniform_neighbor_sample(
        G,
        batch_df,
        fanout,
        with_replacement=False,
