 ...
 */
   ...
   */
    ...
    inline auto operator<<(std::ostream& os, const SelectAlgo& algo) -> std::ostream&
    {
        ...
        switch(algo)
        {
        case SelectAlgo::kAuto:
            return os << "kAuto=" << underlying_value;
        case SelectAlgo::kRadix8bits:
            return os << "kRadix8bits=" << underlying_value;
        case SelectAlgo::kRadix11bits:
            return os << "kRadix11bits=" << underlying_value;
        case SelectAlgo::kRadix11bitsExtraPass:
            return os << "kRadix11bitsExtraPass=" << underlying_value;
        case SelectAlgo::kWarpAuto:
            return os << "kWarpAuto=" << underlying_value;
        case SelectAlgo::kWarpImmediate:
            return os << "kWarpImmediate=" << underlying_value;
        case SelectAlgo::kWarpFiltered:
            return os << "kWarpFiltered=" << underlying_value;
        case SelectAlgo::kWarpDistributed:
            return os << "kWarpDistributed=" << underlying_value;
        case SelectAlgo::kWarpDistributedShm:
            return os << "kWarpDistributedShm=" << underlying_value;
        default:
            throw std::invalid_argument("invalid value for SelectAlgo");
        }
    }
