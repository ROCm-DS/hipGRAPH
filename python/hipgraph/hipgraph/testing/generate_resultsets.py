...
import numpy as np
from hipgraph.datasets import dolphins, karate, karate_disjoint, netscience

# from hipgraph.testing import utils, Resultset, SMALL_DATASETS, results_dir_path
...
if __name__ == "__main__":
    ...
    for dirctd in DIRECTED_GRAPH_OPTIONS:
        ...
        golden_result = hipgraph.bfs_edges(Gnx, source=7)
        hipgraph_df = cudf.from_pandas(golden_result)
        add_resultset(
            hipgraph_df,
    ...
    df = hipgraph.sssp(Gnx, 0, edge_attr="other")
