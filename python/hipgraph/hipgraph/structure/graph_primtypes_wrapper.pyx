...
from hipgraph.structure.utils_wrapper import *
...
# from hipgraph.dask.common.input_utils import DistributedDataHandler
...
def _degree_coo(edgelist_df, src_name, dst_name, direction=Direction.ALL, num_verts=None, sID=None):
    ...
    if sID is not None:
        if True: raise NotImplementedError("Multi-GPU not currently supported")
