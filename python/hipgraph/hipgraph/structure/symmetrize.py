...
from hipgraph.structure import graph_classes as csg
...
def symmetrize_df(
    ...
    multi : bool, optional (default=False)
        ...
        based on if the graph is `curgaph.MultiGraph` or `hipgraph.Graph`.]
...
def symmetrize_ddf(
    ...
    >>> # from hipgraph.structure.symmetrize import symmetrize_ddf
    >>> # Init a DASK Cluster
    >>> # Download dataset from https://github.com/rapidsai/hipgraph/datasets/..
