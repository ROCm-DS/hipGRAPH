...
# this file is pure python and no need to be a cython file. Once hipgraph's
# issue #146 is addressed, this file's extension should be changed from .pyx to
# .py and should be located outside the python/hipgraph/bindings directory.
...
def from_edgelist(
    ...
    create_using: hipgraph.Graph (instance or class), optional (default=Graph)
    ...
    >>> G = hipgraph.Graph()
    >>> G = hipgraph.from_edgelist(M, source='0', destination='1',
    ...                           edge_attr='2')
...
def from_adjlist(offsets, indices, values=None, create_using=Graph):
    ...
    matrix CSR data and returns a new  hipgraph.Graph object.
    ...
    >>> G = hipgraph.from_adjlist(offsets, indices, None)
...
def from_cudf_edgelist(
    ...
    ...                   dtype=['int32', 'int32', 'float32'], header=None)
    >>> G = hipgraph.Graph()
    >>> G = hipgraph.from_cudf_edgelist(M, source='0', destination='1',
    ...                                edge_attr='2')
...
def from_pandas_edgelist(
    ...
    >>> #  https://github.com/rapidsai/hipgraph/datasets/...
