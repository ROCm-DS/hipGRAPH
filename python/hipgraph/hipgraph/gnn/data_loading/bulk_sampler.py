...
from hipgraph.gnn.data_loading.bulk_sampler_io import write_samples
...
class BulkSampler:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        graph: hipgraph.Graph
            The hipgraph graph to operate upon.
    ...
    def flush(self) -> None:
        ...
        if isinstance(self.__graph._plc_graph, pylibhipgraph.graphs.SGGraph):
            sample_fn = hipgraph.uniform_neighbor_sample
        else:
            sample_fn = hipgraph.dask.uniform_neighbor_sample
