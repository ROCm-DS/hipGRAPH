...
import cupy as cp
import numpy
from hipgraph.sampling.sampling_utilities import sampling_results_from_cupy_array_dict
from pylibhipgraph import ResourceHandle
from pylibhipgraph import (
    uniform_neighbor_sample as pylibhipgraph_uniform_neighbor_sample,
)
...
def uniform_neighbor_sample(
    ...
    *,
    ...
    ----------
    G : hipgraph.Graph
        hipGRAPH graph, which contains connectivity information as dask cudf
        edge list dataframe
    ...
    # fanout_vals must be passed to pylibhipgraph as a host array
    ...
    sampling_result_array_dict = pylibhipgraph_uniform_neighbor_sample(
