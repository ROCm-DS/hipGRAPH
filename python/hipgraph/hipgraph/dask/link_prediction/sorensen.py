...
def _call_plc_sorensen(
    ...
    return pylibhipgraph_sorensen_coefficients(
...
def _call_plc_all_pairs_sorensen(
    ...
    return pylibhipgraph_all_pairs_sorensen_coefficients(
        resource_handle=ResourceHandle(Comms.get_handle(sID).getHandle()),
        graph=mg_graph_x,
        vertices=vertices,
        use_weight=use_weight,
...
def sorensen(input_graph, vertex_pair=None, use_weight=False):
    ...
    hipgraph.dask.sorensen, in the absence of a specified vertex pair list, will
