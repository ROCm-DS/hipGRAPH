...
def main(readme_file, objects_filename):
    ...
    from nx_hipgraph.scripts.print_tree import create_tree, tree_lines
...
if __name__ == "__main__":
    # This script imports a nx_hipgraph script module, which imports nx_hipgraph
    ...
    parser = argparse.ArgumentParser(
        "Update README.md to show NetworkX functions implemented by nx-hipgraph"
    )
