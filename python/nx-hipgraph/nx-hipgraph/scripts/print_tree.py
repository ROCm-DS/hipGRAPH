...
from nx_hipgraph.scripts.print_table import Info, get_path_to_info
...
def get_argumentparser(add_help=True):
    parser = argparse.ArgumentParser(
        "Print a tree showing NetworkX functions implemented by nx-hipgraph",
        add_help=add_help,
    )
    parser.add_argument(
        "--by",
    ...
    parser.add_argument(
        ...
        "--pylibhipgraph",
        action="store_true",
        help="Show the used pylibhipgraph function in parentheses",
    )
    parser.add_argument(
        "--version-added",
        "--version_added",
