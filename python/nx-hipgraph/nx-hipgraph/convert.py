...
if TYPE_CHECKING:  # pragma: no cover
    from nx_hipgraph.typing import AttrKey, Dtype, EdgeValue, NodeValue, any_ndarray
...
def from_networkx(
    ...
    *,
    ...
    """Convert a networkx graph to nx_hipgraph graph; can convert all attributes.
    ...
    See Also
    --------
    to_networkx : The opposite; convert nx_hipgraph graph to networkx graph
    """
...
def to_networkx(G: nxcg.Graph, *, sort_edges: bool = False) -> nx.Graph:
    """Convert a nx_hipgraph graph to networkx graph.
    ...
    See Also
    --------
    from_networkx : The opposite; convert networkx graph to nx_hipgraph graph
    """
...
def _to_graph(
    ...
    """Ensure that input type is a nx_hipgraph graph, and convert if necessary.
...
def _to_directed_graph(
    ...
    """Ensure that input type is a nx_hipgraph DiGraph, and convert if necessary.
