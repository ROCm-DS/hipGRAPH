...
use_weight : bool, optional
    If set to True, then compute the weighted jaccard_coefficients (the input graph must be weighted in that case).
    Otherwise, compute the non-weighted jaccard_coefficients.
