...
# Attempt (best effort) to return a list of user specified parameters cmake was invoked with NOTE: Even if the user
# specifies CMAKE_INSTALL_PREFIX on the command line, the parameter is not returned because it does not have the
# matching helpstring
...
function(append_cmake_cli_arguments initial_cli_args return_cli_args)
    ...
    foreach(property ${cmake_properties})
        ...
        if(help_string MATCHES "variable specified on the command line")
            # message( STATUS "property: ${property}") message( STATUS "value: ${${property}}")
