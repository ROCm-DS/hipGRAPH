...
namespace
{
                             ...
                             hipgraph_bool_t store_transposed)
    {
        ...
        hipgraph_rng_state_t*                      p_rng_state = nullptr;
        ...
        ret_code = hipgraph_rng_state_create(p_handle, 0, &p_rng_state, &ret_error);
    ...
    TEST(AlgorithmTest, LeidenNoWeights)
    {
        size_t   num_edges    = 16;
        size_t   num_vertices = 6;
        size_t   max_level    = 10;
