...
namespace
{
    ...
    int generic_eigenvector_centrality_test(const hipgraph_resource_handle_t* p_handle,
                                            vertex_t*                         h_src,
                                            vertex_t*                         h_dst,
                                            weight_t*                         h_wgt,
                                            weight_t*                         h_result,
                                            ...
                                            size_t                            max_iterations)
    {
        ...
        EXPECT_EQ(ret_code, HIPGRAPH_SUCCESS) << "hipgraph_eigenvector_centrality failed.";
    ...
    int test_eigenvector_centrality(const hipgraph_resource_handle_t* p_handle)
    {
        size_t num_edges    = 16;
        ...
        return generic_eigenvector_centrality_test(p_handle,
                                                   h_src,
                                                   h_dst,
                                                   h_wgt,
                                                   h_result,
