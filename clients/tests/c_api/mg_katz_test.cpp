...
namespace
{
    ...
    int generic_katz_test(const hipgraph_resource_handle_t* p_handle,
                          vertex_t*                         h_src,
                          vertex_t*                         h_dst,
                          weight_t*                         h_wgt,
                          weight_t*                         h_result,
                          ...
                          size_t                            max_iterations)
    {
        ...
        ret_code = hipgraph_katz_centrality(p_handle,
                                            ...
                                            &p_result,
                                            &ret_error);
        EXPECT_EQ(ret_code, HIPGRAPH_SUCCESS) << "hipgraph_katz_centrality failed.";
    ...
    int test_katz(const hipgraph_resource_handle_t* p_handle)
    {
        size_t num_edges    = 8;
        ...
        return generic_katz_test(p_handle,
                                 h_src,
                                 h_dst,
                                 h_wgt,
                                 h_result,
