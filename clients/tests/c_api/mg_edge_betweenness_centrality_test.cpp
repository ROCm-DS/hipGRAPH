...
namespace
{
    ...
    int generic_edge_betweenness_centrality_test(const hipgraph_resource_handle_t* p_handle,
                                                 vertex_t*                         h_src,
                                                 vertex_t*                         h_dst,
                                                 weight_t*                         h_wgt,
                                                 vertex_t*                         h_seeds,
                                                 ...
                                                 size_t num_vertices_to_sample)
    {
        ...
        EXPECT_EQ(ret_code, HIPGRAPH_SUCCESS) << "hipgraph_edge_betweenness_centrality failed.";
    ...
    int test_edge_betweenness_centrality(const hipgraph_resource_handle_t* p_handle)
    {
        size_t num_edges    = 16;
        ...
        return generic_edge_betweenness_centrality_test(p_handle,
                                                        h_src,
                                                        h_dst,
                                                        h_wgt,
                                                        nullptr,
