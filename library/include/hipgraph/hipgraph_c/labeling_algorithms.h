 ...
 */
typedef struct hipgraph_labeling_result hipgraph_labeling_result_t;
 ...
 */
HIPGRAPH_EXPORT hipgraph_type_erased_device_array_view_t* hipgraph_labeling_result_get_vertices(
 ...
 */
HIPGRAPH_EXPORT hipgraph_type_erased_device_array_view_t* hipgraph_labeling_result_get_labels(
  hipgraph_labeling_result_t* result);
 ...
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_weakly_connected_components(const hipgraph_resource_handle_t* handle,
 ...
 *                          be populated if error code is not HIPGRAPH_SUCCESS
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_strongly_connected_components(const hipgraph_resource_handle_t* handle,
                                                           hipgraph_graph_t* graph,
                                                           bool do_expensive_check,
                                                           hipgraph_labeling_result_t** result,
                                                           hipgraph_error_t** error);
