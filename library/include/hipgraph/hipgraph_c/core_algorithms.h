 ...
 */
typedef struct hipgraph_core_result hipgraph_core_result_t;

/**
 * @brief       Opaque k-core result type
 */
typedef struct hipgraph_k_core_result hipgraph_k_core_result_t;
 ...
 * @return error code
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_core_result_create(
 ...
 */
HIPGRAPH_EXPORT hipgraph_type_erased_device_array_view_t* hipgraph_core_result_get_vertices(
 ...
 */
HIPGRAPH_EXPORT hipgraph_type_erased_device_array_view_t* hipgraph_core_result_get_core_numbers(
  hipgraph_core_result_t* result);
 ...
 */
HIPGRAPH_EXPORT hipgraph_type_erased_device_array_view_t* hipgraph_k_core_result_get_src_vertices(
 ...
 */
HIPGRAPH_EXPORT hipgraph_type_erased_device_array_view_t* hipgraph_k_core_result_get_dst_vertices(
  hipgraph_k_core_result_t* result);
 ...
 */
HIPGRAPH_EXPORT hipgraph_type_erased_device_array_view_t* hipgraph_k_core_result_get_weights(
  hipgraph_k_core_result_t* result);
...
typedef enum { 
  ...
  HIPGRAPH_K_CORE_DEGREE_TYPE_INOUT = 2  /** Compute core_number using both incoming and outgoing edges */ 
} hipgraph_k_core_degree_type_t;

#  if defined(K_CORE_DEGREE_TYPE_IN)
#    warning "Not re-defining macro K_CORE_DEGREE_TYPE_IN"
#  else
#    define K_CORE_DEGREE_TYPE_IN HIPGRAPH_K_CORE_DEGREE_TYPE_IN
#  endif
#endif
#if defined(HIPGRAPH_NONPREFIXED_ALIASES)
#  if defined(K_CORE_DEGREE_TYPE_OUT)
#    warning "Not re-defining macro K_CORE_DEGREE_TYPE_OUT"
#  else
#    define K_CORE_DEGREE_TYPE_OUT HIPGRAPH_K_CORE_DEGREE_TYPE_OUT
#  endif
#endif
#if defined(HIPGRAPH_NONPREFIXED_ALIASES)
#  if defined(K_CORE_DEGREE_TYPE_INOUT)
#    warning "Not re-defining macro K_CORE_DEGREE_TYPE_INOUT"
#  else
 ...
 * @return error code
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_core_number(const hipgraph_resource_handle_t* handle,
