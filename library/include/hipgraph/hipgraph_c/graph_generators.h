...
typedef enum { 
  HIPGRAPH_POWER_LAW = 0, HIPGRAPH_UNIFORM 
} hipgraph_generator_distribution_t;

#  if defined(POWER_LAW)
#    warning "Not re-defining macro POWER_LAW"
#  else
...
#  if defined(UNIFORM)
#    warning "Not re-defining macro UNIFORM"
#  else
 ...
 * @return error code
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_generate_rmat_edgelist(const hipgraph_resource_handle_t* handle,
 ...
 * @return error code
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_generate_rmat_edgelists(
 ...
 *                                    be populated if error code is not HIPGRAPH_SUCCESS
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_generate_edge_weights(const hipgraph_resource_handle_t* handle,
                                                   hipgraph_rng_state_t* rng_state,
                                                   hipgraph_coo_t* coo,
 ...
 *                                    be populated if error code is not HIPGRAPH_SUCCESS
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_generate_edge_ids(const hipgraph_resource_handle_t* handle,
                                               hipgraph_coo_t* coo,
                                               bool multi_gpu,
                                               hipgraph_error_t** error);
 ...
 *                                    be populated if error code is not HIPGRAPH_SUCCESS
 */
HIPGRAPH_EXPORT hipgraph_error_code_t hipgraph_generate_edge_types(const hipgraph_resource_handle_t* handle,
                                                 hipgraph_rng_state_t* rng_state,
                                                 hipgraph_coo_t* coo,
