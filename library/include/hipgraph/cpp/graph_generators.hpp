 ...
 */
#if !defined(_hipgraph__/GRAPH_GENERATORS_HPP_)
#define _hipgraph__/GRAPH_GENERATORS_HPP_ 1
...
#endif
#else
#include <rocgraph/./graph_generators.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./graph_generators.hpp"
...
#endif // _hipgraph__/GRAPH_GENERATORS_HPP_
