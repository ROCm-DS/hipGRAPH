#if !defined(HIPGRAPH_HDR___LEGACY_INTERNALS_HPP_)
#define HIPGRAPH_HDR___LEGACY_INTERNALS_HPP_ 1
/*
...
#endif
#else
#include <rocgraph/cpp/./legacy/internals.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "legacy/internals.hpp"
namespace hipgraph
{
...
{
    // Namespaces
    namespace internals = ::hipgraph::backend::internals;
} // namespace hipgraph

#endif // HIPGRAPH_HDR___LEGACY_INTERNALS_HPP_
