 ...
 */
#if !defined(_hipgraph__/LEGACY/FUNCTIONS_HPP_)
#define _hipgraph__/LEGACY/FUNCTIONS_HPP_ 1
...
#endif
#else
#include <rocgraph/./legacy/functions.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./legacy/functions.hpp"
...
#endif // _hipgraph__/LEGACY/FUNCTIONS_HPP_
