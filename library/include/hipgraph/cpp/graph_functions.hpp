 ...
 */
#if !defined(_hipgraph__/GRAPH_FUNCTIONS_HPP_)
#define _hipgraph__/GRAPH_FUNCTIONS_HPP_ 1
...
#endif
#else
#include <rocgraph/./graph_functions.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./graph_functions.hpp"
...
#endif // _hipgraph__/GRAPH_FUNCTIONS_HPP_
