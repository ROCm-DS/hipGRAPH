 ...
 */
#if !defined(_hipgraph__/UTILITIES/ERROR_HPP_)
#define _hipgraph__/UTILITIES/ERROR_HPP_ 1
...
#endif
#else
#include <rocgraph/./utilities/error.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./utilities/error.hpp"
...
#endif // _hipgraph__/UTILITIES/ERROR_HPP_
