#if !defined(HIPGRAPH_HDR___UTILITIES_DEVICE_PROPERTIES_HPP_)
#define HIPGRAPH_HDR___UTILITIES_DEVICE_PROPERTIES_HPP_ 1
/*
...
#endif // HIPGRAPH_HDR___UTILITIES_DEVICE_PROPERTIES_HPP_
