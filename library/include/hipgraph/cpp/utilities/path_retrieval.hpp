 ...
 */
#if !defined(_hipgraph__/UTILITIES/PATH_RETRIEVAL_HPP_)
#define _hipgraph__/UTILITIES/PATH_RETRIEVAL_HPP_ 1
...
#endif
#else
#include <rocgraph/./utilities/path_retrieval.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./utilities/path_retrieval.hpp"
...
#endif // _hipgraph__/UTILITIES/PATH_RETRIEVAL_HPP_
