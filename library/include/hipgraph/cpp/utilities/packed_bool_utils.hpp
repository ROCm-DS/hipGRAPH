 ...
 */
#if !defined(_hipgraph__/UTILITIES/PACKED_BOOL_UTILS_HPP_)
#define _hipgraph__/UTILITIES/PACKED_BOOL_UTILS_HPP_ 1
...
#endif
#else
#include <rocgraph/./utilities/packed_bool_utils.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./utilities/packed_bool_utils.hpp"
...
#endif // _hipgraph__/UTILITIES/PACKED_BOOL_UTILS_HPP_
