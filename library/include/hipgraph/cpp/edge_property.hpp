 ...
 */
#if !defined(_hipgraph__/EDGE_PROPERTY_HPP_)
#define _hipgraph__/EDGE_PROPERTY_HPP_ 1
...
#endif
#else
#include <rocgraph/./edge_property.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./edge_property.hpp"
...
#endif // _hipgraph__/EDGE_PROPERTY_HPP_
