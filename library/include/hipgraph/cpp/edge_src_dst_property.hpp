 ...
 */
#if !defined(_hipgraph__/EDGE_SRC_DST_PROPERTY_HPP_)
#define _hipgraph__/EDGE_SRC_DST_PROPERTY_HPP_ 1
...
#endif
#else
#include <rocgraph/./edge_src_dst_property.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./edge_src_dst_property.hpp"
...
#endif // _hipgraph__/EDGE_SRC_DST_PROPERTY_HPP_
