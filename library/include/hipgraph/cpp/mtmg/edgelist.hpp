 ...
 */
#if !defined(_hipgraph__/MTMG/EDGELIST_HPP_)
#define _hipgraph__/MTMG/EDGELIST_HPP_ 1
...
#endif
#else
#include <rocgraph/./mtmg/edgelist.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./mtmg/edgelist.hpp"
...
#endif // _hipgraph__/MTMG/EDGELIST_HPP_
