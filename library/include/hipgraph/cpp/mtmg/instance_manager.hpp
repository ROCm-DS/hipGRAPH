 ...
 */
#if !defined(_hipgraph__/MTMG/INSTANCE_MANAGER_HPP_)
#define _hipgraph__/MTMG/INSTANCE_MANAGER_HPP_ 1
...
#endif
#else
#include <rocgraph/./mtmg/instance_manager.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./mtmg/instance_manager.hpp"
...
#endif // _hipgraph__/MTMG/INSTANCE_MANAGER_HPP_
