 ...
 */
#if !defined(_hipgraph__/MTMG/GRAPH_VIEW_HPP_)
#define _hipgraph__/MTMG/GRAPH_VIEW_HPP_ 1
...
#endif
#else
#include <rocgraph/./mtmg/graph_view.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./mtmg/graph_view.hpp"
...
#endif // _hipgraph__/MTMG/GRAPH_VIEW_HPP_
