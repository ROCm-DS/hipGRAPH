 ...
 */
#if !defined(_hipgraph__/MTMG/RENUMBER_MAP_HPP_)
#define _hipgraph__/MTMG/RENUMBER_MAP_HPP_ 1
...
#endif
#else
#include <rocgraph/./mtmg/renumber_map.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "./mtmg/renumber_map.hpp"
...
#endif // _hipgraph__/MTMG/RENUMBER_MAP_HPP_
