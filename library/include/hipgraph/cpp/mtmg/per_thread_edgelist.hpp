#if !defined(HIPGRAPH_HDR___MTMG_PER_THREAD_EDGELIST_HPP_)
#define HIPGRAPH_HDR___MTMG_PER_THREAD_EDGELIST_HPP_ 1
/*
...
#define HIPGRAPH_BACKEND_DECLARED_ "mtmg/per_thread_edgelist.hpp"
namespace hipgraph
{
...
#endif
#else
#include <rocgraph/cpp/./mtmg/per_thread_edgelist.hpp>
#if !defined(HIPGRAPH_BACKEND_DECLARED_)
#define HIPGRAPH_BACKEND_DECLARED_ "mtmg/per_thread_edgelist.hpp"
namespace hipgraph
{
...
#endif // HIPGRAPH_HDR___MTMG_PER_THREAD_EDGELIST_HPP_
